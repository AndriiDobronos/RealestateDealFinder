...
const money = (value: number, currency?: string) => {
  ...
  return ['UAH', 'USD', 'EUR'].includes(code) ? new Intl.NumberFormat('uk-UA', { style: 'currency', currency: code, maximumFractionDigits: 0 }).format(value) : `${number.format(value)} ${currency || 'валюта не вказана'}`
}
